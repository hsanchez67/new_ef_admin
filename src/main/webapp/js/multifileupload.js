(function ($) {
    ...
    function createMultiUploadIframe(frameId, uri) {
    ...
    function createMultiUploadForm(formId, files, data) {
    ...
    $.multiFileUpload = function (s) {
        ...
        var form = createMultiUploadForm(formId, s.files, (typeof(s.data) == 'undefined' ? false : s.data));
        var io = createMultiUploadIframe(frameId, s.secureuri);
