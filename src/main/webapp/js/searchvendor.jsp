...
function ajaxGetDetail(jid){
    ...
    $.ajax({
        type: "POST",
        url: '${pageContext.request.contextPath}/vendorJobs/ajax/getVendorJobDetail',
        dataType: 'json',
        ...
        success: function(data) {
            ...
            if (data) {                      		 
            		$("#detail_jobId").text(data.vendorJobId);
            		$("#detail_vendorId").text(data.vendorId);
            		$("#detail_vendorId").text(data.vendorId);
            		$("#detail_appendType").text(data.appendType);
            		$("#detail_precision").text(parsePrecision(data.precision));
            		$("#detail_createdTs").text(formatDate(data.createdTs));
            		$("#detail_filename").text(removeSpecialChars(data.filename));
            		$("#detail_submitTs").text(formatDate(data.submitTs));
            		$("#detail_receiveTs").text(formatDate(data.recieveTs));
            		$("#detail_downloadTs").text(formatDate(data.downloadTs));
            		$("#detail_lastModifiedTs").text(formatDate(data.lastModifiedTs));            		            			  			            	
